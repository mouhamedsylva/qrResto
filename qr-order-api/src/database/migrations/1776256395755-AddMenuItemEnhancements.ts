...
export class AddMenuItemEnhancements1776256395755 implements MigrationInterface {
    name = 'AddMenuItemEnhancements1776256395755'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`isAvailable\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`isActive\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`isDishOfDay\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`prepTime\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`calories\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`allergens\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`dietaryLabels\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`availableDays\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`ordersCount\` int NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`subcategoryName\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`ordersCount\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`availableDays\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`dietaryLabels\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`allergens\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`calories\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`prepTime\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`isDishOfDay\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`isActive\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`isAvailable\` tinyint NOT NULL DEFAULT '1'`);
    }
