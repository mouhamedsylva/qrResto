...
export class AddSubCategories1776734317053 implements MigrationInterface {
    name = 'AddSubCategories1776734317053'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`menu_items\` CHANGE \`subcategoryName\` \`subCategoryId\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`subCategoryId\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`subCategoryId\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD CONSTRAINT \`FK_f1d359a55923bb45b057fbdab0d\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`subCategoryId\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`subCategoryId\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`menu_items\` CHANGE \`subCategoryId\` \`subcategoryName\` varchar(255) NULL DEFAULT 'NULL'`);
    }
