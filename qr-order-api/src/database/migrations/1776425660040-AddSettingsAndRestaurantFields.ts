...
export class AddSettingsAndRestaurantFields1776425660040 implements MigrationInterface {
    name = 'AddSettingsAndRestaurantFields1776425660040'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // These keys and indexes were already dropped in a previous partial execution
        ...
        // await queryRunner.query(`DROP INDEX \`FK_fe8e7d37475de7eb2f8f83a6da0\` ON \`categories\``);
        // await queryRunner.query(`DROP INDEX \`FK_d56e5ccc298e8bf721f75a7eb96\` ON \`menu_items\``);
        // await queryRunner.query(`DROP INDEX \`FK_f1d359a55923bb45b057fbdab0d\` ON \`order_items\``);
        // await queryRunner.query(`DROP INDEX \`FK_d8453d5a71e525d9b406c35aab8\` ON \`order_items\``);
        // await queryRunner.query(`DROP INDEX \`FK_2312cd07a04f50ba29d76c9564e\` ON \`orders\``);
        // await queryRunner.query(`DROP INDEX \`FK_2a7fdd7af437285a3ef0fc8b64f\` ON \`orders\``);
        // await queryRunner.query(`DROP INDEX \`FK_94e0a6541322cecd437cd841701\` ON \`tables\``);
        // await queryRunner.query(`DROP INDEX \`FK_8efcb4b7bc1122ed19df1897d22\` ON \`subscriptions\``);
        
        // These columns were already added to 'restaurants' in a previous partial execution
        // await queryRunner.query(`ALTER TABLE \`restaurants\` ADD \`description\` text NULL`);
        // await queryRunner.query(`ALTER TABLE \`restaurants\` ADD \`email\` varchar(255) NULL`);
        
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` ADD \`buttonStyle\` varchar(255) NOT NULL DEFAULT 'rounded'`);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` ADD \`prepTime\` int NOT NULL DEFAULT '20'`);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` ADD \`paymentCash\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` ADD \`paymentCard\` tinyint NOT NULL DEFAULT 1`);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` ADD \`paymentOnline\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` DROP COLUMN \`paymentOnline\``);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` DROP COLUMN \`paymentCard\``);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` DROP COLUMN \`paymentCash\``);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` DROP COLUMN \`prepTime\``);
        await queryRunner.query(`ALTER TABLE \`restaurant_settings\` DROP COLUMN \`buttonStyle\``);
        ...
        await queryRunner.query(`CREATE INDEX \`FK_8efcb4b7bc1122ed19df1897d22\` ON \`subscriptions\` (\`restaurantId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_94e0a6541322cecd437cd841701\` ON \`tables\` (\`restaurantId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_2a7fdd7af437285a3ef0fc8b64f\` ON \`orders\` (\`tableId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_2312cd07a04f50ba29d76c9564e\` ON \`orders\` (\`restaurantId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_d8453d5a71e525d9b406c35aab8\` ON \`order_items\` (\`menuItemId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_f1d359a55923bb45b057fbdab0d\` ON \`order_items\` (\`orderId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_d56e5ccc298e8bf721f75a7eb96\` ON \`menu_items\` (\`categoryId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_fe8e7d37475de7eb2f8f83a6da0\` ON \`categories\` (\`restaurantId\`)`);
    }
