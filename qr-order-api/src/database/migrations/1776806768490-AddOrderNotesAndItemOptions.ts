...
export class AddOrderNotesAndItemOptions1776806768490 implements MigrationInterface {
    name = 'AddOrderNotesAndItemOptions1776806768490'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`sub_categories\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`order\` int NOT NULL DEFAULT '0', \`isActive\` tinyint NOT NULL DEFAULT 1, \`categoryId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP COLUMN \`subcategoryName\``);
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD \`selectedOptions\` json NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`menu_items\` CHANGE \`subCategoryId\` \`subCategoryId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD CONSTRAINT \`FK_b7a9415608473b9fb37aab26fc6\` FOREIGN KEY (\`subCategoryId\`) REFERENCES \`sub_categories\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_d8453d5a71e525d9b406c35aab8\``);
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_f1d359a55923bb45b057fbdab0d\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP FOREIGN KEY \`FK_b7a9415608473b9fb37aab26fc6\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` DROP FOREIGN KEY \`FK_d56e5ccc298e8bf721f75a7eb96\``);
        await queryRunner.query(`ALTER TABLE \`categories\` DROP FOREIGN KEY \`FK_fe8e7d37475de7eb2f8f83a6da0\``);
        await queryRunner.query(`ALTER TABLE \`sub_categories\` DROP FOREIGN KEY \`FK_dfa3adf1b46e582626b295d0257\``);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD CONSTRAINT \`FK_d8453d5a71e525d9b406c35aab8\` FOREIGN KEY (\`menuItemId\`) REFERENCES \`menu_items\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`order_items\` ADD CONSTRAINT \`FK_f1d359a55923bb45b057fbdab0d\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`menu_items\` CHANGE \`subCategoryId\` \`subCategoryId\` varchar(36) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP COLUMN \`selectedOptions\``);
        await queryRunner.query(`ALTER TABLE \`menu_items\` ADD \`subcategoryName\` varchar(255) NULL DEFAULT 'NULL'`);
